...
class _$ServerImpl implements _Server {
  const _$ServerImpl(this.message, [this.statusCode]);
...
abstract class _Server implements AppException {
  const factory _Server(final String message, [final int? statusCode]) =
      _$ServerImpl;
...
abstract class _Auth implements AppException {
...
class __$$CacheImplCopyWithImpl<$Res>
    extends _$AppExceptionCopyWithImpl<$Res, _$CacheImpl>
...
class _$CacheImpl implements _Cache {
  const _$CacheImpl(this.message);
...
abstract class _Cache implements AppException {
