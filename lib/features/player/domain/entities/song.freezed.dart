...
class _$SongImpl implements _Song {
  ...
  @override
  String toString() {
    return 'Song(id: $id, title: $title, artist: $artist, album: $album, thumbnailUrl: $thumbnailUrl, audioUrl: $audioUrl, duration: $duration, isLiked: $isLiked)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, artist, album,
      thumbnailUrl, audioUrl, duration, isLiked);
